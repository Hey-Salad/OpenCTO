...
export interface Env {
  ...
  APP_BASE_URL: string
  GOOGLE_LIVE_BACKEND_URL?: string
  GOOGLE_LIVE_SHARED_SECRET?: string
  GOOGLE_LIVE_DEFAULT_MODEL?: string
  GOOGLE_LIVE_ALLOWED_MODELS?: string
  GOOGLE_LIVE_SESSION_TTL_SECONDS?: string
  ...
  RATE_LIMIT_GOOGLE_LIVE_SESSIONS_PER_MINUTE?: string
